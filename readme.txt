Este é um trading system automatizado em Python voltado a detectar variações bruscas de certos ativos da Bolsa de Valores,o trading system se baseia em executar umma operação na ponta contrária a de qualquer variação que se distancie demais da média de retornos do ativo, com timeframe de D+1.
